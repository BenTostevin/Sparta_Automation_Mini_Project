Feature: Asos Login
  ...
  Scenario Outline: The day entered in the date field does not exist in the month entered
    Given I access the asos registration page
    And I enter the day in the date field <day>
    When I enter the month in the date field <month>
    Then I get the following date error: <error>

    Examples:
     | day | month | error |
     | 31 | February | That doesn't look right… Add your date of birth to get a birthday treat! |

  Scenario Outline: You are too young to register so an error message is returned
    Given I access the asos registration page
    And I enter the day in the date field <day>
    And I enter the month in the date field <month>
    When I enter the year in the date field <year>
    Then I get the following date error: <error>

    Examples:
     | day | month | year | error |
     | 31 | December | 2002 | Oops. Looks like you're too young to use ASOS. |
